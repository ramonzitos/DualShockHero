# Script copy from http://pygame.org/wiki/Pygame2exe
...
class BuildExe:
    def __init__(self):
        ...
        #Auhor of program
        self.author_name = "Ramon Dantas"
        self.author_email = "ramonzitosdesorte@hotmail.com"
        self.copyright = "Copyright (C) 2012  Ramon Dantas"
 
        #Description
        self.project_description = "DualShockHero"
